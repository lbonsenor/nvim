...
return {
  ...
  init = function()
    ...
    local color_fg1 = '#1e1832'
    local color_fg2 = '#092b1b'
    local color_fg3 = '#00242c' -- colors['linkarzu_color20']
    local color_fg4 = '#232436' -- colors['linkarzu_color21']
    local color_fg5 = '#063531' -- colors['linkarzu_color22']
    local color_fg6 = '#1c3249' -- colors['linkarzu_color23']
    -- local color_sign = "#ebfafa"
